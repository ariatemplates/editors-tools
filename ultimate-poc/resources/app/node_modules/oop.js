...
function klass(input) {
	...
	var spec = dop.processProperties(input, {
		properties: [
			...
			{names: ['parent', 'superclass', 'superClass', 'super', 'ancestor', 'base']},
	...
	if (prelude.isType('Object', callback)) {
		...
		callback = dop.extractValue(callback, ['def', 'definition', 'fn', 'callback', 'handler']);
	...
	function constructor() {
		...
		if (schema != null) {
			dop.processProperties(self, arguments[0], schema, self);
		}
...
/**
 * @todo Matbe put properties on the generated function, this way its behavior could be changed at runtime.
 */
