...
* [`range.js`](./range.js): a class to handle ranges, taht is a pair of numbers with notions of beginning, end, exclusion, inclusion
...
* Color
	...
	* add conversion methods (probably use a third-party) module
