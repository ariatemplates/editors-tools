			...
			input: {
				...
				properties: [
					...
					},
					{
						...
						desc: 'The start index relative to the current code from which the given text will be set.',
						default: function() {return this.source.length;}, // appended text by default
						type: oop.types.Number
					},
					{
						names: ['end', 'stop'],
						desc: 'The end index relative to the current code until which the given text will be set.',
						// inferred: 'start'
						type: oop.types.Number
					},
					{
