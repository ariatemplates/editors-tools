...
This command uses a binary installed by npm, in the [`node_modules`](ultimate-poc/resources/node_modules) folder dedicated to third-parties libraries. If it doesn't work, maybe the PEG.js module was not properly installed, try reinstalling it.
...
* Should HTML recognize [CDATA](http://en.wikipedia.org/wiki/CDATA)? XHTML I guess yes.
