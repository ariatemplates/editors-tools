...
function getOptions(input) {
	return dop.extractProperty(input, {names: ["options", "opts"]}) || {};
}
...
var Mode = oop.Class({
	...
	prototype: {
		 ...
		 */
		_cleanGraph: function(graph) {
			var newGraph = graph.copy();

			newGraph.traverse(function(node) {
				delete node.parent;
			});
		...
		graph: function(code, options) {
			...
			var library = dop.extractValue(options ['library', 'lib', 'type', 'framework', 'engine', 'system']) || "cytoscape";
