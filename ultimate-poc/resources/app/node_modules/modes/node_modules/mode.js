...
var SessionManager = require('std/opt/session').SessionManager;
...
var Mode = oop.Class({
	...
	constructor: function(input) {
		...
		if (!this.parser || !(prelude.isType('Function', this.parser.parse))) {
			throw {
				msg: 'Invalid given parser',
				parser: this.parser
			};
	...
	prototype: {
		...
		_parse: function(input) {
			return this.parser.parse(input.source, input.rule);
		},
		 ...
		 */
		parse: function() {
			return this.cleanGraph(this._parse.apply(this, arguments));
		},
